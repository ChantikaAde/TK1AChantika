...
public class Tarik extends javax.swing.JFrame {
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(118, 118, 118)
                        .addComponent(txtNominal, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(97, 97, 97))
        );
    ...
    private void btnTarikActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTarikActionPerformed
        try {
            ...
            if (nominal > akun.getSaldo()) {
                JOptionPane.showMessageDialog(this, "Saldo tidak Cukup!");
            } else if (akun.getSaldo() - nominal < 50000) {
                JOptionPane.showMessageDialog(this, "Minimal saldo Rp 50.000 harus tersisa setelah penarikan!");
            } else {
                akun.setSaldo(akun.getSaldo() - nominal);
                JOptionPane.showMessageDialog(this, "Penarikan berhasil. Sisa saldo: Rp " + akun.getSaldo());
            }
